    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('clientes.update', $cliente->id) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="documento_identidad" name="documento_identidad" value="{{ $cliente->documento_identidad }}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="numero_celular" name="numero_celular" value="{{ $cliente->numero_celular }}" required>
            </div>
            <div class="form-group">
